Учебный репозиторий по курсу «Введение в веб-технологии» (раздел DevOps). Создан в рамках лабораторной работы №0: Создание репозитория и настройка рабочего окружения. 
